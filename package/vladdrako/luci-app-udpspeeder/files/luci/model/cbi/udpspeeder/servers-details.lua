...
m = Map("udpspeeder", "%s - %s" %{translate("UDPspeeder"), translate("Edit Config")})
...
o = s:taboption("basic_settings", Value, "server_ip", translate("Server Address"))
o.datatype = "string"
...
o = s:taboption("common_settings", Value, "fec", translate("FEC"), translate("1. forward error correction, send y redundant packets for every x packets. 2. fine-grained fec parameters,may help save bandwidth. example: \"-f 1:3,2:4,10:6,20:10\". check repo for details."))
o.datatype = "string"
o.placeholder = "20:10"

o = s:taboption("common_settings", Value, "timeout", translate("Timeout"), translate("how long could a packet be held in queue before doing fec, unit: ms, default: 8ms."))
o.datatype = "uinteger"
o.placeholder = "8"
...
o = s:taboption("advanced_settings", ListValue, "mode", translate("Mode"), translate("fec-mode,available values: 0,1; mode 0(default) costs less bandwidth,no mtu problem. mode 1 usually introduces less latency, but you have to care about mtu."))
o:value("0")
o:value("1")
o.default = "0"

o = s:taboption("advanced_settings", Value, "mtu", translate("MTU"), translate("mtu. for mode 0, the program will split packet to segment smaller than mtu value. for mode 1, no packet will be split, the program just check if the mtu is exceed."))
o.datatype = "range(100,1400)"
o.placeholder = "1250"

o = s:taboption("advanced_settings", Value, "queue_len", translate("Queue Len"), translate("fec queue len, only for mode 0, fec will be performed immediately after queue is full. default value: 200."))
o.datatype = "uinteger"
o:depends("mode", "0")
o.placeholder = "200"
